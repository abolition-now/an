...
<Slider iiifContent="/an/api/facet/subject/abolition.json" />

<Slider iiifContent="/an/api/facet/subject/punishment.json" />

<Slider iiifContent="/an/api/facet/subject/worldingfutures.json" />

<Slider iiifContent="/an/api/facet/artist/micah-bazant.json" />

<Slider iiifContent="/an/api/facet/visual-motifs/hands.json" />

<Slider iiifContent="/an/api/facet/visual-motifs/pigs.json" />
