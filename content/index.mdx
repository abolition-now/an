...
<Slider iiifContent="/an-ia-staging/api/facet/artist/micah-bazant.json" />

<Slider iiifContent="/an-ia-staging/api/facet/visual-motifs/hands.json" />

<Slider iiifContent="/an-ia-staging/api/facet/visual-motifs/pigs.json" />

<Slider iiifContent="/an-ia-staging/api/facet/visual-motifs/flora.json" />

<Slider iiifContent="/an-ia-staging/api/facet/visual-motifs/fire.json" />

<Slider iiifContent="/an-ia-staging/api/facet/geography/palestine.json" />
